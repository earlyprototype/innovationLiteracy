...
Behaviours are the observable, practicable actions that translate innovation mindsets into productive practice. They are habits that can be developed through deliberate practice, reinforced by facilitation, and sustained by environment.

Mindset without behaviour is aspiration. Behaviour without mindset is performance. Effective innovation requires both.

## Why It Matters

Innovation behaviours are team capabilities as much as individual ones. They only produce full value when practised collectively and established as explicit shared norms rather than left to individual initiative.

Without these behaviours, teams accumulate the appearance of innovation (meetings, workshops, ideation sessions) without the substance. With these behaviours practised consistently, even simple processes produce meaningful outcomes.

## How It Shows Up in Practice

**Active Listening:** Deliberate, disciplined practice of receiving, processing, and integrating another person's perspective before responding. The foundational innovation behaviour.

Active listening underpins:
- Discovery phase (quality of insight depends on quality of listening)
- Ideation (building on others' ideas requires understanding them first)
- Testing (feedback only useful if genuinely heard, not filtered through confirmation bias)
- Team dynamics (psychological safety foundation)

Involves: full attention, clarifying questions, paraphrasing to confirm understanding, suspending judgement, attending to non-verbal cues.
...
**Sharing Work in Progress:** Willingness to make thinking visible before it's "finished" or "ready". Innovation depends on early, frequent feedback. Ideas kept private until polished miss opportunity for iterative improvement. Requires trust and explicit norms making it clear that unfinished work is expected and welcomed.
