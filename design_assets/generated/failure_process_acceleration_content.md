# Prompt: Failure Mode 6: Process Acceleration Without Integrity — Content Card (b_coral_teal)
...
**Visual Concept:**
A premium editorial diagnostic analysis infographic presenting "What Happens", "Why It Occurs", "How It Shows Up" for Failure Mode 6: Process Acceleration Without Integrity. Clean flat vector layout with considered asymmetry, generous whitespace, and clear typographic hierarchy across three horizontal zones.
...
- **Title:** Failure Mode 6: Process Acceleration Without Integrity — large bold serif, left-aligned, generous breathing room.
- A thin primary accent underline beneath the title.
- **Subtitle:** AI speed tempts teams to skip essential process steps. Process collapses to "problem brief → AI solution → ship." — humanist sans-serif, light weight, directly beneath.
...
**Left Column:**
Accent-coloured square bullets (4pt) with body text. Items reading: "Skipping Discovery: "We don't need user interviews, AI [...]"; "Skipping Iteration: "First AI output looks good, ship it""; "Skipping Testing: "AI validated our idea" (echo [...]".

**Right Column:**
Horizontal timeline with numbered circles (secondary accent stroke, no fill) connected by a hairline rule in primary accent. Steps: 1. Maintain process gates:: AI [...] → 2. Position AI as accelerator not [...] → 3. Facilitation discipline:: Hold the [...]. Step labels positioned below in sentence case.

### Footer Zone (bottom of frame)

Key points from "How It Shows Up" rendered as accent-coloured square bullets: "Skipping Discovery: "We don't need user [...]"; "Skipping Iteration: "First AI output looks [...]"; "Skipping Testing: "AI validated our idea" [...]".
