# Prompt: Failure Mode 1: Echo Chamber Effect — Content Card (b_coral_teal)
...
**Visual Concept:**
A premium editorial diagnostic analysis infographic presenting "What Happens", "Why It Occurs", "How It Shows Up" for Failure Mode 1: Echo Chamber Effect. Clean flat vector layout with considered asymmetry, generous whitespace, and clear typographic hierarchy across three horizontal zones.
...
- **Title:** Failure Mode 1: Echo Chamber Effect — large bold serif, left-aligned, generous breathing room.
- A thin primary accent underline beneath the title.
- **Subtitle:** AI reflects your existing assumptions and biases back to you, creating false validation. — humanist sans-serif, light weight, directly beneath.
...
**Left Column:**
Accent-coloured square bullets (4pt) with body text. Items reading: "Discovery/Research: AI "critique" that validates all [...]"; "Problem Framing: Problem statements that perfectly [...]"; "Evaluation: AI assessment agreeing with your preferred [...]".

**Right Column:**
Horizontal timeline with numbered circles (secondary accent stroke, no fill) connected by a hairline rule in primary accent. Steps: 1. Request challenge explicitly:: [...] → 2. Run Gate 4 (Bias Amplification):: [...] → 3. Use human peer review for [...]. Step labels positioned below in sentence case.

### Footer Zone (bottom of frame)

Key points from "How It Shows Up" rendered as accent-coloured square bullets: "Discovery/Research: AI "critique" that [...]"; "Problem Framing: Problem statements that [...]"; "Evaluation: AI assessment agreeing with your [...]".
