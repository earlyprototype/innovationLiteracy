# Prompt: Failure Mode 6: Process Acceleration Without Integrity — Title Card (b_coral_teal)
...
- **Title:** Failure Mode 6: Process Acceleration Without Integrity (large, bold serif, positioned top-left with generous breathing room)
...
**Visual Concept:**
A flat vector illustration of: A five-stage pipeline compressed into a single step — four stages crossed out with a bold arrow jumping from brief to ship. Rendered as clean geometric shapes with solid colour fills on the background. Abstract and evocative — not literal. No text rendered in the illustration.
<!-- image_meta_description: A five-stage pipeline compressed into a single step — four stages crossed out with a bold arrow jumping from brief to ship. -->
