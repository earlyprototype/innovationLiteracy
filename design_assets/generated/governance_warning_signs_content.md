# Prompt: Governance Warning Signs — Content Card (b_coral_teal)
...
**Visual Concept:**
A premium editorial diagnostic analysis infographic presenting "Why It Matters", "The Warning Signs" for Governance Warning Signs. Clean flat vector layout with considered asymmetry, generous whitespace, and clear typographic hierarchy across three horizontal zones.
...
- **Title:** Governance Warning Signs — large bold serif, left-aligned, generous breathing room.
- A thin primary accent underline beneath the title.
- **Subtitle:** Governance failures don't announce themselves. — humanist sans-serif, light weight, directly beneath.
- **Card type label:** DIAGNOSTIC CARD (small caps, top-right, teal) · GOVERNANCE (small caps, bold top-right, coral)

### Content Zone (middle of frame — asymmetric two-column)

**Left Column:**
A pulled quote in 18pt body text: "Governance failures don't announce themselves." with a thin primary accent left-border rule (2px).

**Right Column:**
A pulled quote in 18pt body text: "Symptom: "We need you on this deadline — innovation can wait." Ring-fenced days postponed [...]" with a thin primary accent left-border rule (2px).
