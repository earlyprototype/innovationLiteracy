# Prompt: Interventions Taxonomy: Prototype & Test Stages — Title Card (d_amber_teal)
...
Title: Interventions Taxonomy: Prototype & Test Stages
Subtitle: Make thinking tangible and testable. Prototypes are questions, not answers.
...
**Visual Concept:**
A flat vector illustration of: Three prototypes of the same concept at different fidelity levels — paper sketch, cardboard model, digital wireframe — each with testing notes pinned alongside. Rendered as clean geometric shapes with solid colour fills on the background. Abstract and evocative — not literal. No text rendered in the illustration.
<!-- image_meta_description: Three prototypes of the same concept at different fidelity levels — paper sketch, cardboard model, digital wireframe — each with testing notes pinned alongside. -->
