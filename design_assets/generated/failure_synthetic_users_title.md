# Prompt: Failure Mode 2: Synthetic User Substitution — Title Card (b_coral_teal)
...
Title: Failure Mode 2: Synthetic User Substitution
Subtitle: AI-generated "user personas" or "synthetic interviews" replace actual human discovery.
...
**Visual Concept:**
A flat vector illustration of: A mannequin seated in a user interview chair, holding scripted answers — while a real person waits unseen outside the door. Rendered as clean geometric shapes with solid colour fills on the background. Abstract and evocative — not literal. No text rendered in the illustration.
