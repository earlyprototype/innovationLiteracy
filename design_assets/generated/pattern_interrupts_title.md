# Prompt: Pattern Interrupts: Micro-Interventions That Change Behaviour — Title Card (d_amber_teal)
...
- **Title:** Pattern Interrupts: Micro-Interventions That Change Behaviour (large, bold serif, positioned top-left with generous breathing room)
...
**Visual Concept:**
A flat vector illustration of: A stream of identical gears in mechanical rhythm, disrupted by a single red cog forcing the whole mechanism to shift direction. Rendered as clean geometric shapes with solid colour fills on the background. Abstract and evocative — not literal. No text rendered in the illustration.
