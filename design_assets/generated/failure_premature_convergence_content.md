# Prompt: Failure Mode 3: Premature Convergence via High Fidelity — Content Card (b_coral_teal)
...
**Visual Concept:**
A premium editorial diagnostic analysis infographic presenting "What Happens", "Why It Occurs", "How It Shows Up" for Failure Mode 3: Premature Convergence via High Fidelity. Clean flat vector layout with considered asymmetry, generous whitespace, and clear typographic hierarchy across three horizontal zones.
...
- **Title:** Failure Mode 3: Premature Convergence via High Fidelity — large bold serif, left-aligned, generous breathing room.
- A thin primary accent underline beneath the title.
- **Subtitle:** AI generates polished, high-fidelity outputs too early in process, forcing convergence before [...] — humanist sans-serif, light weight, directly beneath.
- **Card type label:** DIAGNOSTIC CARD (small caps, top-right, teal) · TOOLS (small caps, bold top-right, coral)

### Content Zone (middle of frame — asymmetric two-column)

**Left Column:**
Accent-coloured square bullets (4pt) with body text. Items reading: "Ideate: Skipping rough sketching because AI generates [...]"; "Prototype: High-fidelity UI generated before workflow [...]"; "Decision-Making: Committing because outputs look [...]".

**Right Column:**
Horizontal timeline with numbered circles (secondary accent stroke, no fill) connected by a hairline rule in primary accent. Steps: 1. Fidelity discipline — match tool [...] → 2. Deliberately constrain AI:: [...] → 3. Maintain human sketching: even [...]. Step labels positioned below in sentence case.

### Footer Zone (bottom of frame)

Key points from "How It Shows Up" rendered as accent-coloured square bullets: "Ideate: Skipping rough sketching because AI [...]"; "Prototype: High-fidelity UI generated before [...]"; "Decision-Making: Committing because outputs [...]".
