# Prompt: The AI Tools Landscape (2026) — Content Card (b_coral_teal)
...
**Visual Concept:**
A premium editorial reference-style infographic presenting "Categories", "Strategic Recommendations" for The AI Tools Landscape (2026). Clean flat vector layout with considered asymmetry, generous whitespace, and clear typographic hierarchy across three horizontal zones.
...
- **Title:** The AI Tools Landscape (2026) — large bold serif, left-aligned, generous breathing room.
- A thin primary accent underline beneath the title.
- **Subtitle:** ### 1. AI App Builders & Rapid Prototyping — humanist sans-serif, light weight, directly beneath.
...
**Left Column:**
Accent-coloured square bullets (4pt) with body text. Items reading: "[Bolt.new](https://bolt.new/) — Browser-based, [...]"; "[Lovable](https://lovable.dev/) — Conversation-first, [...]"; "[v0 by Vercel](https://v0.dev/) — Generative UI → [...]"; "[Cursor](https://cursor.com/) — VS Code fork, [...]".

**Right Column:**
Accent-coloured square bullets (4pt) with body text. Items reading: "Standardise on Markdown — enables synthesis tools to [...]"; "Match tool to task — App Builders for desirability, [...]"; "Consider interoperability — MCP enables AI agents to [...]".

### Footer Zone (bottom of frame)

Key points from "Strategic Recommendations" rendered as accent-coloured square bullets: "Standardise on Markdown — enables synthesis [...]"; "Match tool to task — App Builders for [...]"; "Consider interoperability — MCP enables AI [...]".
