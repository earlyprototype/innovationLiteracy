# Prompt: Interventions Taxonomy: Discovery Stage — Title Card (d_amber_teal)
...
- **Title:** Interventions Taxonomy: Discovery Stage (large, bold serif, positioned top-left with generous breathing room)
...
**Visual Concept:**
A flat vector illustration of: A field researcher's toolkit laid open — notebook, camera, empathy map template, five-why ladders — ready for structured exploration. Rendered as clean geometric shapes with solid colour fills on the background. Abstract and evocative — not literal. No text rendered in the illustration.
