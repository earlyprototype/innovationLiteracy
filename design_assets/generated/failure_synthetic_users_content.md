# Prompt: Failure Mode 2: Synthetic User Substitution — Content Card (b_coral_teal)
...
**Visual Concept:**
A premium editorial diagnostic analysis infographic presenting "What Happens", "Why It Occurs", "How It Shows Up" for Failure Mode 2: Synthetic User Substitution. Clean flat vector layout with considered asymmetry, generous whitespace, and clear typographic hierarchy across three horizontal zones.
...
- **Title:** Failure Mode 2: Synthetic User Substitution — large bold serif, left-aligned, generous breathing room.
- A thin primary accent underline beneath the title.
- **Subtitle:** AI-generated "user personas" or "synthetic interviews" replace actual human discovery. — humanist sans-serif, light weight, directly beneath.
...
**Left Column:**
Accent-coloured square bullets (4pt) with body text. Items reading: "Discovery: User needs based on AI speculation rather [...]"; "Problem Framing: Problems defined based on assumed [...]"; "Testing: "Validation" from AI role-playing users [...]".

**Right Column:**
Key points from "Why It Occurs" rendered as accent-coloured square bullets: "Pressure for speed makes synthetic users seductive"; "Difficulty accessing real users creates [...]"; "AI-generated content sounds plausible and [...]".

### Footer Zone (bottom of frame)

Key points from "How It Shows Up" rendered as accent-coloured square bullets: "Discovery: User needs based on AI [...]"; "Problem Framing: Problems defined based on [...]"; "Testing: "Validation" from AI role-playing [...]".
