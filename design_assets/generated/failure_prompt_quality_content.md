# Prompt: Failure Mode 7: Prompt Quality as Incidental — Content Card (b_coral_teal)
...
**Visual Concept:**
A premium editorial diagnostic analysis infographic presenting "What Happens", "Why It Occurs", "How It Shows Up" for Failure Mode 7: Prompt Quality as Incidental. Clean flat vector layout with considered asymmetry, generous whitespace, and clear typographic hierarchy across three horizontal zones.
...
- **Title:** Failure Mode 7: Prompt Quality as Incidental — large bold serif, left-aligned, generous breathing room.
- A thin primary accent underline beneath the title.
- **Subtitle:** Teams treat prompt writing as incidental rather than core skill. — humanist sans-serif, light weight, directly beneath.
...
**Left Column:**
Accent-coloured square bullets (4pt) with body text. Items reading: "Vague Prompts: "Design a better UX" (no context, [...]"; "Frustration: "AI doesn't understand what I want" / [...]"; "Missing Iteration: Accepting first output even when [...]".

**Right Column:**
Horizontal timeline with numbered circles (secondary accent stroke, no fill) connected by a hairline rule in primary accent. Steps: 1. Treat prompt engineering as core [...] → 2. Prompt co-creation: — pairs/groups [...] → 3. Iteration discipline: — Generate → [...] → 4. Frame it:: "Prompt iteration IS [...]. Step labels positioned below in sentence case.

### Footer Zone (bottom of frame)

Key points from "How It Shows Up" rendered as accent-coloured square bullets: "Vague Prompts: "Design a better UX" (no [...]"; "Frustration: "AI doesn't understand what I [...]"; "Missing Iteration: Accepting first output [...]".
