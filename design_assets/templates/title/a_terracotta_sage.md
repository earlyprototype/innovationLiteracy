# Base Template: a — Terracotta + Sage — Title Card
...
- **Title:** {{TITLE}} (large, bold serif, positioned top-left with generous breathing room)
...
- Primary Accent: Terracotta (`#C1666B`) for {{PRIMARY_ACCENT_USAGE}}.
- Secondary Accent: Sage Green (`#8B9D83`) for {{SECONDARY_ACCENT_USAGE}}.
- Text Colour: Deep Charcoal (`#2C2C2C`).
- Extra elements: {{EXTRA_ELEMENTS — any metaphor-specific colours or details}}.
...
The number "{{GHOST_NUMBER}}" is rendered at approximately 1000pt in a refined serif typeface, at only 4% opacity, positioned in the right area of the card, partially cut off and bleeding off the edge. The number is in charcoal (#2C2C2C) at 4% opacity so it appears as a faint impression on the off-white background. It sits behind all other content and should never interfere with readability.
