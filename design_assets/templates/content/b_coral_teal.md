# Base Template: b — Coral + Teal — Content Card
...
- **Card type label:** {{CARD_TYPE_LABEL_1}} (small caps, top-right, teal) · {{CARD_TYPE_LABEL_2}} (small caps, bold top-right, coral)
...
- Primary Accent: Electric Coral (`#FF6B6B`) for {{PRIMARY_ACCENT_USAGE}}.
- Secondary Accent: Vibrant Teal (`#00E5FF`) for {{SECONDARY_ACCENT_USAGE}}.
